...
val p  = new Person("vivek","Kale")               //> p  : Study.Person = Study$$anonfun$main$1$Person$1@7823a2f9

p.printHome                                       //> home in akola


//Prob: control the visibility of fields
p.fName                                           //> res2: String = vivek
...
val e2 = e.asInstanceOf[Long]                     //> e2  : Long = 10


def printAll(num:Int*)
{
	println("class"+num.getClass)
}                                                 //> printAll: (num: Int*)Unit
